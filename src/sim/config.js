...
export const ZONE_DISTANCE_RANGE = [3, 10]; // distance from the hub for new zones
...
export const MISSION_GOALS = { quick: 0.5, regular: 1 };
...
export const HOME_FERTILITY_PCT_RANGE = [40, 60];
export const FERTILITY_RANGE = [0.3, 1.0]; // [min, max] rolled for discovered zones
export const ORE_RICHNESS_RANGE = [0.3, 1.0];
